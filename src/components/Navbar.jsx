...
// import tutLogo from '../images/logo.png';.00000000000000
...
export function Navbar() {
  ...
  const navItems = [
    ...
    { label: "Partnership", url: "/partnership", newTab: false },
  ...
  const handleNavClick = (e, target) => {
...

    {
      ...
      if (element) {
        ...
        // If element not found on current page (e.g. from Career page), navigate to home with hash
        navigate(`/#${targetId}`);
      }
    }
    setIsMobileMenuOpen(false);
