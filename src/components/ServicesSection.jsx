...
const details = {
  'Annual maintenance contract':
    'Comprehensive upkeep and lifecycle support.',
  'Design review ':
    'Architecture validation and risk analysis.',
  'Best practices assessment reviews':
    'Security posture benchmarking and audits.',
  'Resident engineer services':
    'Onsite implementation and troubleshooting.',
  'Paloalto Implementation':
    'Deployment and tuning aligned to compliance.',
  'Bespoke Services':
    'Custom security engagements and solutions.',
};
